...
/**
 * This class represents Settle Payment ResponseInterface Entity
 */
class SettlePaymentResponse extends ResponseEntity
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->result = new SettlePaymentResultEntity($result);
    }
}
