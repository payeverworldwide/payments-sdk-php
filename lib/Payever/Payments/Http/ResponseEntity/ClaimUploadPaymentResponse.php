...
use Payever\Sdk\Payments\Http\MessageEntity\ClaimUploadPaymentResultEntity;
use Payever\Sdk\Payments\Http\MessageEntity\PaymentCallEntity;

/**
 * This class represents Claim Upload Payment ResponseInterface Entity
 *
 * @method PaymentCallEntity getCall()
 * @method ClaimPaymentResultEntity getResult()
 */
class ClaimUploadPaymentResponse extends ResponseEntity
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->result = new ClaimUploadPaymentResultEntity($result);
    }
}
